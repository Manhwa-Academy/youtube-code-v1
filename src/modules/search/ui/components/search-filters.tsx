    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-[700px] w-[95vw] rounded-2xl p-0 gap-0 bg-white dark:bg-zinc-900 border-none shadow-2xl overflow-hidden">
        <DialogHeader className="p-4 px-6 border-b border-neutral-200 dark:border-neutral-800 flex flex-row items-center justify-between">
          <DialogTitle className="text-lg font-normal">Bộ lọc tìm kiếm</DialogTitle>
        </DialogHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                ...
                <FilterItem label="Kênh" value="channel" currentValue={type} filterKey="type" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                <FilterItem label="Dưới 3 phút" value="under_3" currentValue={duration} filterKey="duration" />
                <FilterItem label="Từ 3 đến 20 phút" value="3_to_20" currentValue={duration} filterKey="duration" />
                <FilterItem label="Trên 20 phút" value="over_20" currentValue={duration} filterKey="duration" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                <FilterItem label="Hôm nay" value="today" currentValue={uploadDate} filterKey="uploadDate" />
                <FilterItem label="Tuần này" value="this_week" currentValue={uploadDate} filterKey="uploadDate" />
                <FilterItem label="Tháng này" value="this_month" currentValue={uploadDate} filterKey="uploadDate" />
                <FilterItem label="Năm nay" value="this_year" currentValue={uploadDate} filterKey="uploadDate" />
              </div>
            </div>
